...
$stmt = mysqli_prepare($conn, "INSERT INTO trial (assignment_id, trial_no, start_time_ms, end_time_ms) VALUES (?, ?, ?, ?)");
mysqli_stmt_bind_param($stmt, 'iiss', $assignmentId, $trialNo, $startTimeMs, $endTimeMs);
